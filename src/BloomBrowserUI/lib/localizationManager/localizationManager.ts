...
export class LocalizationManager {
    ...
    */
    ...
    // uses Bloom's translate API (which in turn uses libpalaso's index,
    // the users's setttings, and localization files)
    // to get the best way to display this language
    asyncGetLanguageName(iso): JQueryPromise<any> {
        return this.asyncGetTextInLang("LanguageNames." + iso, iso, "UI");
    }
