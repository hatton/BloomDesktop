...
module.exports = {
    ...
    resolve: {
        ...
        //We may need to add .less here... otherwise maybe it will ignore them unless they are require()'d
    ...
    plugins: [
        new webpack.optimize.CommonsChunkPlugin({ name: "common", filename: "commonBundle.js" }),
