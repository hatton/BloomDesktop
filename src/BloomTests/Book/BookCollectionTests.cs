...
namespace BloomTests.Book
{
	...
	public class BookCollectionTests
	{
		...
		{
			return new Bloom.Book.Book(bookInfo,  storage, null, new CollectionSettings(new NewCollectionSettings() { PathToSettingsFile = CollectionSettings.GetPathForNewSettings(_folder.Path, "test"),  AbsoluteLanguage1Iso639Code = "xyz" }),
													new PageSelection(),
